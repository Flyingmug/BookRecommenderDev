...
public class clientBR extends Application {
  ...
  public void start(Stage stage) throws IOException {
    ...
    Font.loadFont(getClass().getResourceAsStream("/bookrecommenderdev/fonts/Montserrat/static/Montserrat-Italic.ttf"), 16);
    Font.loadFont(getClass().getResourceAsStream("/bookrecommenderdev/fonts/Gabriola/Gabriola.ttf"), 16);
